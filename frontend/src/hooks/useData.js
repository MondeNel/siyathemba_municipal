...
const SEED = {
  posts: [
    { id: "p1", title: "Water Supply Interruption – Prieska North", content: "Residents of Prieska North are advised that water supply will be interrupted on 15 April 2026 from 08:00–17:00 for scheduled infrastructure maintenance. Water tankers will be available at the civic centre.", category: "Infrastructure", author: "Technical Services", created_at: "2026-04-08" },
    { id: "p2", title: "Mayor's Report: Q1 Service Delivery Update", content: "The Executive Mayor presents the Q1 2026 service delivery report highlighting achievements in road rehabilitation, housing projects, and community facilities expansion across all wards.", category: "Council", author: "Office of the Mayor", created_at: "2026-04-05" },
  ...
  events: [
    { id: "e1", title: "Community Imbizo – Ward 3", description: "The Executive Mayor will host a community imbizo to discuss service delivery challenges and municipal plans for Ward 3.", date: "2026-04-18", time: "10:00", location: "Ward 3 Community Hall, Prieska", category: "Council Engagement" },
    { id: "e2", title: "Budget 2026/27 Public Participation", description: "Citizens are invited to participate in the municipal budget process.", date: "2026-04-22", time: "09:00", location: "Civic Centre, Prieska", category: "Finance" },
    { id: "e3", title: "Freedom Day Commemoration", description: "The municipality invites all residents to the official Freedom Day commemoration ceremony.", date: "2026-04-27", time: "08:00", location: "Prieska Stadium", category: "Civic" },
    { id: "e4", title: "Indigent Register Update Drive", description: "Municipal officials will visit all wards to update the indigent register.", date: "2026-05-05", time: "08:00", location: "All Wards – Mobile Units", category: "Community" },
    { id: "e5", title: "Youth Day Sports Festival", description: "Annual Youth Day sports festival hosted by Community Services.", date: "2026-06-16", time: "08:00", location: "Prieska Sports Grounds", category: "Civic" },
  ],
  documents: [
    { id: "d1", title: "Draft Budget 2026/27", description: "Siyathemba Local Municipality Draft Budget and Tariffs for the 2026/27 financial year.", file_url: "#", category: "Budget & Tariffs", file_size: "2.4 MB", file_type: "PDF", downloads: 312, created_at: "2026-04-01" },
    ...
    { id: "d6", title: "Draft Tariffs 2026/27 – Schedule A", description: "Draft tariff schedule for water, electricity, refuse removal and other municipal services.", file_url: "#", category: "Budget & Tariffs", file_size: "0.8 MB", file_type: "PDF", downloads: 201, created_at: "2026-04-01" },
  ],
  notices: [
    { id: "n1", title: "Chief Traffic Officer: Law Enforcement & Licensing", content: "Applications are invited for the post of Chief Traffic Officer. Closing date: 20 April 2026.", category: "vacancy", urgency: "normal", created_at: "2026-04-01" },
  ...
  tenders: [
    { id: "t1", reference: "SLM-T-2026-001", title: "Supply and Installation of Solar Street Lights – Phase 2", description: "Supply, delivery and installation of 120 solar-powered street lights across Prieska and Marydale.", category: "tender", closing_date: "2026-05-02", status: "open", created_at: "2026-04-01" },
    { id: "t2", reference: "SLM-Q-2026-014", title: "Provision of Catering Services – Imbizo Events", description: "Quotations invited for catering services for municipal imbizo events.", category: "quotation", closing_date: "2026-04-18", status: "open", created_at: "2026-04-05" },
