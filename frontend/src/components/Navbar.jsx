...
export default function Navbar({ data }) {
  ...
  const newPosts = getNewCount(data?.posts);
  const newEvents = getNewCount(data?.events);
  const newDocuments = getNewCount(data?.documents);
  const newNotices = getNewCount(data?.notices);
  const newTenders = getNewCount(data?.tenders);
